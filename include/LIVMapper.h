...
public:
  ...
  // Global-LVBA dataset exporter (output layer only)
  bool global_lvba_output_en = false;
  string global_lvba_sequence_name = "sequence";
  string global_lvba_output_dir;
  ofstream fout_lvba_image_pose;
  ofstream fout_lvba_lidar_pose;
